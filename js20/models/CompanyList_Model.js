...
function CompanyList_Model(options){
	var id = 'CompanyList_Model';
	options = options || {};
	...
	options.fields.clients_ref = new FieldJSON("clients_ref",filed_options);
		...
		CompanyList_Model.superclass.constructor.call(this,id,options);
}
extend(CompanyList_Model,ModelXML);

...
function User_Model(options){
	...
	options.fields.sex = new FieldEnum("sex",filed_options);
	filed_options.enumValues = 'male,female';
	...
	filed_options.enumValues = 'admin,client_admin1,client_admin2,person';
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Поле убрать, тк есть компания, а площадка это родитель компании';
	filed_options.autoInc = false;	
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'URL личного кабинета';
	filed_options.autoInc = false;	
	
	options.fields.person_url = new FieldString("person_url",filed_options);
	options.fields.person_url.getValidator().setMaxLength('32');
	
				
	
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Представление пользователя, идексированное поле для полиска. Обновляется триггером';
	filed_options.autoInc = false;	
	...
	options.fields.qr_code = new FieldBytea("qr_code",filed_options);
	...
	options.fields.qr_code_sent_date = new FieldDateTimeTZ("qr_code_sent_date",filed_options);

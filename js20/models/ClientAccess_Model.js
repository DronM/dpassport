...
function ClientAccess_Model(options){
	var id = 'ClientAccess_Model';
	options = options || {};
	...
	options.fields.doc_1c_ref = new FieldJSONB("doc_1c_ref",filed_options);
		...
		ClientAccess_Model.superclass.constructor.call(this,id,options);
}
extend(ClientAccess_Model,ModelXML);

...
function StudyDocumentAttachmentList_Model(options){
	var id = 'StudyDocumentAttachmentList_Model';
	options = options || {};
	...
	options.fields.content_preview = new FieldString("content_preview",filed_options);
		...
		StudyDocumentAttachmentList_Model.superclass.constructor.call(this,id,options);
}
extend(StudyDocumentAttachmentList_Model,ModelXML);

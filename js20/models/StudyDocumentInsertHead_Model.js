...
function StudyDocumentInsertHead_Model(options){
	var id = 'StudyDocumentInsertHead_Model';
	options = options || {};
	...
	options.fields.common_series = new FieldString("common_series",filed_options);
	options.fields.common_series.getValidator().setMaxLength('50');
	...
	options.fields.common_study_form = new FieldText("common_study_form",filed_options);
		...
		StudyDocumentInsertHead_Model.superclass.constructor.call(this,id,options);
}
extend(StudyDocumentInsertHead_Model,ModelXML);

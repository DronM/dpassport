...
function StudyDocumentInsertList_Model(options){
	var id = 'StudyDocumentInsertList_Model';
	options = options || {};
	...
	options.fields.name_full = new FieldText("name_full",filed_options);
		...
		StudyDocumentInsertList_Model.superclass.constructor.call(this,id,options);
}
extend(StudyDocumentInsertList_Model,ModelXML);

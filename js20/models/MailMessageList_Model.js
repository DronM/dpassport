...
function MailMessageList_Model(options){
	var id = 'MailMessageList_Model';
	options = options || {};
	...
	options.fields.body_begin = new FieldText("body_begin",filed_options);
	...
	filed_options.enumValues = 'person_register,password_recover,admin_1_register,client_activation,client_registration,client_expiration,person_url,user_activation,client_order';
	...
	options.fields.attachment_count = new FieldInt("attachment_count",filed_options);
	
		MailMessageList_Model.superclass.constructor.call(this,id,options);
}
extend(MailMessageList_Model,ModelXML);

...
//	console.log("EditFile.prototype.setValue", v)
	//console.dir(v)
...
//console.log("EditFile.prototype.addFile ", fileInf)
//debugger
	var cont = this.getElement("file_cont");
...
//console.log("Creating control with ID=",file_id)	
	...
	if (this.m_showPic&&fileInf.dataBase64){		
		cont.addElement(new Control(file_id+"-preview","TEMPLATE",{

...
type StudyForm_complete_argv struct {
	Argv *StudyForm_complete `json:"argv"`	
}

//Exported model metadata
var StudyForm_complete_md fields.FieldCollection

func StudyForm_complete_Model_init() {	
	StudyForm_complete_md = fields.GenModelMD(reflect.ValueOf(StudyForm_complete{}))
}

//
type StudyForm_complete struct {

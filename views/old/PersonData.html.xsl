...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="pd_css/style.css" />
	...
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>        	
        ...
        <script src='js20/pd.js?{$VERSION}2'></script>
    </head>
	...
	<xsl:variable name="cert_id" select="id"/>
                ...
                <div class="block-body">
                    <div class="back-side container" cert_id="{$cert_id}">
						...
						<xsl:call-template name="format_date">
							<xsl:with-param name="val" select="issue_date"/>
							<xsl:with-param name="yearFormat" select="2"/>
						</xsl:call-template>																					
                                        </div>
                                    </div>
                                    <div class="body__right-organiztion">
                                        <div>Аттестован в:</div>
                                        <div>
						<div><xsl:value-of select="organization"/>
                                        </div>
                                    </div>
                                    <div class="body__right-date--end">
                                        <div>Сроком до:</div>
